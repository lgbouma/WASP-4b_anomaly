    ...
    if onlytransits:
        ...
        if include_all_points:
            a0.errorbar(x_extra,
                        ...
                        sigma_y_extra,
                        fmt='.', color='purple', ecolor='purple', zorder=1,
                        alpha=1, mew=1, elinewidth=1)
            a0.text(0.96,0.02,
                    'Southworth+19\n'+
                    '(overplot; not included in fits)',
                    transform=a0.transAxes, color='purple', fontsize='x-small',
                    va='bottom', ha='right')
            #a0.text(0.96,0.02,
        ...
        if not include_all_points:
            ...
            a0.legend(loc=(0.9, 0.9), fontsize='x-small', framealpha=1)
...
def main(plname, xlim=None, ylim=None, include_all_points=False, ylim1=None):
    ...
    if include_all_points:
        ...
        extrafile = '../data/WASP-4b_manual_extra_SOUTHWORTH.csv'
    ...
    if not include_all_points:
        savpath = '../results/O_minus_C.png'
    else:
        savpath = '../results/O_minus_C_includeallpoints.png'
