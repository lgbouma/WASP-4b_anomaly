...
def plot_rvs_paperII():

    setupfn = "/home/luke/Dropbox/proj/WASP-4b_anomaly/src/WASP4.py"
    outputdir = "/home/luke/Dropbox/proj/WASP-4b_anomaly/results/rv_fitting/LGB_20190911_fix_gammaddot_paperII"
    ...
    # plot the maxlikelihood fit, which has already been performed in LGB_20190911_fix_gammaddot
    # radvel plot -t rv -s $basepath
    args.type = ['rv']
    plots(args) # pulled from radvel.driver.plots
