...
\tablecomments{
  ...
  \replaced{$\sigma_{t_0}$}{$\sigma_{t_{\rm tra}}$} was evaluated from the 
  sampled posteriors by taking
  the maximum of the difference between the 84th percentile
  minus the median, and the median minus the 16th percentile.
  \added{The resulting error variances then appeared to have been overestimated, so 
  we lowered the uncertainties as described in \S~\ref{sec:measurement}.}
