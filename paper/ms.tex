...
\begin{abstract}
  ...
  WASP-4b have recently shown that its orbital period appears to be decreasing.
  ...
  m}\,{\rm s}^{-1}\,{\rm day}^{-1}$.  The implied period decrease
...
$\omega=90^\circ$.  Substituting $P\approx 1.25\tau$, $K \approx
0.5\tau \gammadot$ into the mass function \citep[{\it
