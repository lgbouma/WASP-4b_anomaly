...
\begin{abstract}
    ...
    based on data stretching back to 2007.  This is unlikely
    ...
    constant period, ruling out an 81.6-second offset at the
    ...
    possibility, although at present there is no evidence for such a
...
computer.  The data were downlinked via the Deep Space Network, and the
spacecraft time stamps were calibrated against the ground-station clocks.
The spacecraft clock times were then transformed by the
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Verifying the TESS Time Stamps Using Other Hot Jupiters}
...
time stamps and the true ${\rm BJD}_{\rm TDB}$ reference.  Our priors
were
\begin{align}
...
% \end{figure*}
% 
% The preceding analysis shows that the TESS time stamps are consistent
...
% time stamps. Since the ETD data come from
% heterogeneous sources, their time stamps are less clearly documented,
