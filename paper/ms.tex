...
A.~Bailey, F.~Dai, K.~Patra and V.~Van Eylen, and are grateful to the
...
corrected only late in the mission~\citep[][Section
  3.4]{kepler_DR19_2013}. We performed two checks on the calibration of 
the TESS time system, described below.
...
JD}_{\rm UTC}$ time stamp, we calculated the barycentric correction
