...
\title{The Early Arrival of WASP-4\lowercase{b}}
...
\begin{abstract}
  ...
  transits seem to have arrived $77.8 \pm 10.8$ seconds early, and the
  period appears to be shrinking by $\dot{P}=-12.1 \pm 1.2$
  milliseconds per year.   From TESS observations of WASPs-6b, -18b,
  and -46b, we show that a systematic offset between the TESS times
  and the barycentric reference sufficient to explain WASP-4b is ruled
  out at 6.3$\sigma$.  The timing variations seem to be astrophysical,
...
\citet{stassun_accurate_2017} found the bolometric flux from
broad-band photometry.  Combining the implied angular radius with the
{\it Gaia} DR2 parallax, and adjusting for the parallax offset
\citep{stassun_evidence_2018}, we obtain the stellar radius.  For the
stellar mass, we started with the $a/R_\star$ value found by
