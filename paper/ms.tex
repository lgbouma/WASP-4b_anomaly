...
substantially affect any of our conclusions.
...
reduced images and their reconstructed speckle images,  contrast
curves are produced yielding 5-sigma detection limits  (see
\citealt{howell_speckle_2011}).  No companions were detected, and the
second night, which had better seeing (0.6$''$), also produced the
more constraining result.  The 832$\,$nm limits were the most useful
to us given that faint companions are redder than the host star.  We
therefore opted to use the 832$\,$nm September 28-29 contrast limits
...
The best-fit period derivative in the quadratic model is then
\begin{equation}
\dot{P}
...
\begin{figure}[t]
    ...
    1.26~{\rm msec}\,{\rm yr}^{-1}$) is indicated with the purple dotted
...
transits ($\dot{P}= - 8.64 \pm 1.26~{\rm msec}\,{\rm yr}^{-1}$) seems to
...
perfect, Occam's razor would suggest that most or all of the apparent
...
however is usually negative, and might manifest as an asymmetry in the
...
period derivatives will begin to be measured with precision exceeding
$1~{\rm msec}\,{\rm yr}^{-1}$ over the coming decade.
