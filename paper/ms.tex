...
period decrease of $\approx$30 milliseconds per year is almost
certainly due to tidal orbital decay
...
the fourth power of the baseline duration (Section~\ref{sec:fisher}), and
so within a decade many more hot Jupiters should show orbital period
changes due to accelerations induced by their outer companions.  
