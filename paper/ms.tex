...
% similar age and mass
% \citep{penev_hats-18_2016,penev_empirical_2018}.  This is expected
% because when the orbital frequency is larger than the spin rotation
% frequency, tides donate angular momentum from the planet to the
% star.  The reverse process occurs between the Earth and Moon,
% leading to the Moon's slowly increasing separation from Earth of
% $X.XX$cm~yr$^{-1}$ (CITE lunar ranging experiment).  The hot Jupiter
% star-planet separation distribution is best reproduced by models
% that account for tides~\citep{cameron_hierarchical_2018}.
...
% FIXME: take a look at RVs. rule this out, or understand where the
% bounds are.
