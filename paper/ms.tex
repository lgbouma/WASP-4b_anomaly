...
\explain{We learned about this after submission.}
\subsection{Astrometry}

\added{
In review, it came to our attention that observations by the Gaia satellite...
%FIXME
}
...
\added{
However, because we are observing the primary star accelerate towards
our line of sight, the companion very well be near
inferior conjunction.
We incorporate the relevant projection effects
...
argument of periastron of the outer simulated companion.  \deleted{We converted
...
\added{We then incorporated the speckle imaging limits in each simulated
...
imaging observation (September 28, 2019).  If a simulated companion's
mass and projected separation put it above the 5$\sigma$ contrast curve,
we assumed it would have been detected.
We multiplied
the resulting $128\times128\times512$ cubes of radial velocity and speckle
imaging probabilities, and marginalized over the systems in each grid cell to
