...
%SOI on the SOAR 4.2-m telescope.
%\citet{hoyer_tramos_2013} also
...
%In other words, assuming the linear model is true, there is a
%$10^{-23}$ probability that simply by chance we would see data that
%favors the quadratic model more strongly than the observations.
...
\acknowledgements{
L.G.B.\ happily acknowledges helpful discussions with A. Bailey, F.
Dai and V. Van Eylen, and is grateful to the people who have
contributed to TESS.
%
