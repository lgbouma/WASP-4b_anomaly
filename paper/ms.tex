...
Jupiters satisfy this condition, so their orbits should be shrinking
\citep{levrard_falling_2009,matsumura_tidal_2010}.  However the rate of decay
is uncertain, as it depends on how friction dissipates energy carried by
...
understanding of tidal dissipation.  This would be important because the
...
inspiral, causing a `direct-impact' merger
\citep{metzger_optical_2012,macleod_planetary_2018} Alternatively, if
the planet fills its Roche lobe above the stellar surface, then
...
In exoplanetary systems, precessing orbits have been detected in a
handful of cases, including circumbinary systems (Kepler-413
...
planet by the star's tidal force \citep{ragozzine_probing_2009}.  
If apsidal precession were observed in a hot Jupiter system, the
precession rate could thus be used to compute the planet's Love
number, giving a third parameter along with the mass and radius with
which to describe the planet's interior structure \citep[{\it
e.g.},][who performed a similar procedure for
