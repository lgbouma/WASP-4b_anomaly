...
{\it Transit/RV parameters:} & & & \\
  $R_{\rm p}/R_\star$                        & $0.XXXX$               & $\pm 0.0013$                & A \\
  $i$~[deg]                                  & $XX.XX$                & $+0.39$, $-0.26$            & A \\
  $a/R_\star$                                & $5.XXX$                & $+0.025$, $-0.020$          & A \\
...
remaining analysis.  Our parameters broadly agree with those of
previous authors
...
ground in the $K_S$ band, and gave a time in HJD, without
...
\citep{eastman_achieving_2010}.
Though not rigorous, this procedure inflated the error bar to a more
